...
def setup():
    ...
    sinrg = input('Do you want to Delete a Single DN or DN Range from a Service Provider? (Single/Range)')
    ...
    #Add Dn(s)
    OCI_Session.command("ServiceProviderDnDeleteListRequest", **params)
